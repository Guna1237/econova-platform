...
import { Newspaper, Edit2, Trash2, Plus, Globe, Eye, EyeOff } from 'lucide-react';
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{ display: 'flex', gap: '1rem' }}>
                                ...
                                {editingItem && (
                                    <button
                                        type="button"
                                        onClick={() => { setEditingItem(null); setFormData({ title: '', content: '', source: 'Global News Network', is_published: true, image_url: '' }); }}
                                        className="btn"
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                        <div>
                                            <div style={{ fontSize: '0.8rem', color: '#666', marginBottom: '0.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                ...
                                                {item.is_published ? 'PUBLISHED' : 'DRAFT'} • {new Date(item.published_at).toLocaleString()}
                                            </div>
